...
public class WalletMain {
   ...
   static String[] dataSource =  {"B5","Q","B20","Q","B10","P","N","N","D","Q","Q"};
   ...
   public static void main (String[] args) {
	  ...
	  myWallet.printForward();
	  System.out.println();
	  myWallet.printBackward();
	  System.out.println();
	  myWallet.printRecursiveSum();
	  System.out.println();
	  myWallet.printRecursiveQuarters();
   }
